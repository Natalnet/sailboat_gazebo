...
#include "LiftDragPluginNboatSail.h"

using namespace gazebo;

GZ_REGISTER_MODEL_PLUGIN(LiftDragPluginNboatSail)

/////////////////////////////////////////////////
LiftDragPluginNboatSail::LiftDragPluginNboatSail() : cla(1.0), cda(0.01), cma(0.01), rho(1.2041)
{
...
/////////////////////////////////////////////////
LiftDragPluginNboatSail::~LiftDragPluginNboatSail()
{
}

/////////////////////////////////////////////////
void LiftDragPluginNboatSail::Load(physics::ModelPtr _model,
                     sdf::ElementPtr _sdf)
{
  GZ_ASSERT(_model, "LiftDragPluginNboatSail _model pointer is NULL");
  GZ_ASSERT(_sdf, "LiftDragPluginNboatSail _sdf pointer is NULL");
  this->model = _model;
  this->sdf = _sdf;

  this->world = this->model->GetWorld();
  GZ_ASSERT(this->world, "LiftDragPluginNboatSail world pointer is NULL");

  this->physics = this->world->Physics();
  GZ_ASSERT(this->physics, "LiftDragPluginNboatSail physics pointer is NULL");
  ...
  if (_sdf->HasElement("link_name"))
  {
    ...
    if (!this->link)
    {
      gzerr << "Link with name[" << linkName << "] not found. "
        << "The LiftDragPluginNboatSail will not generate forces\n";
    }
    else
    {
      this->updateConnection = event::Events::ConnectWorldUpdateBegin(
          std::bind(&LiftDragPluginNboatSail::OnUpdate, this));
    }
  }
  ...
  ros::SubscribeOptions so =
    ros::SubscribeOptions::create<std_msgs::Float64>(
        ...
        1,
        boost::bind(&LiftDragPluginNboatSail::OnRosMsg, this, _1),
