...
#include "LiftDragPluginNboat.h"

using namespace gazebo;

GZ_REGISTER_MODEL_PLUGIN(LiftDragPluginNboat)

/////////////////////////////////////////////////
LiftDragPluginNboat::LiftDragPluginNboat() : cla(1.0), cda(0.01), cma(0.01), rho(1.2041)
{
...
/////////////////////////////////////////////////
LiftDragPluginNboat::~LiftDragPluginNboat()
{
}

/////////////////////////////////////////////////
void LiftDragPluginNboat::Load(physics::ModelPtr _model,
                     sdf::ElementPtr _sdf)
{
  GZ_ASSERT(_model, "LiftDragPluginNboat _model pointer is NULL");
  GZ_ASSERT(_sdf, "LiftDragPluginNboat _sdf pointer is NULL");
  this->model = _model;
  this->sdf = _sdf;

  this->world = this->model->GetWorld();
  GZ_ASSERT(this->world, "LiftDragPluginNboat world pointer is NULL");

  this->physics = this->world->Physics();
  GZ_ASSERT(this->physics, "LiftDragPluginNboat physics pointer is NULL");
  ...
  if (_sdf->HasElement("link_name"))
  {
    ...
    if (!this->link)
    {
      gzerr << "Link with name[" << linkName << "] not found. "
        << "The LiftDragPluginNboat will not generate forces\n";
    }
    else
    {
      this->updateConnection = event::Events::ConnectWorldUpdateBegin(
          std::bind(&LiftDragPluginNboat::OnUpdate, this));
    }
  }
...
/////////////////////////////////////////////////
void LiftDragPluginNboat::OnUpdate()
{
  GZ_ASSERT(this->link, "Link was NULL");
